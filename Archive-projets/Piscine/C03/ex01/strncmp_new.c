...
n = 2;
result = ft_strncmp("abcdeeg", "abcdf", n); // ma fonction
benchmark = strncmp("abcdeeg", "abcdf", n); // strncmp
//						s1	 ,	  s2  , n
...
printf("my function, different strings for %d characters, return value: %d.\n", n, result);
