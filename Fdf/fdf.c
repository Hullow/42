...
/*   Updated: 2024/05/07 23:42:01 by francis          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_rotate_z_on_key(t_env *env)
{
	ft_z_rotation(env->point_list, 30);
}
...
int	key_handler(int keycode, t_env *env)
{
	...
	else if (keycode == 16)
	{
		...
		// ft_clear_pixels(env);
		ft_z_rotation(env->point_list, -60);
		// ft_rotate_z_on_key(env);
		ft_draw_lines(env);
