...
/*   Updated: 2024/06/20 17:17:15 by fallan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// cost
void					ft_calculate_cost(t_stack *a_elem, t_stacks *stacks,
							t_cost *cost);
void					ft_set_initial_costs(t_stack *a_elem, t_stacks *stacks,
							t_cost *cost);
...
// moves
void					ft_do_cheapest_insertion(t_stacks *stacks,
...
// checker
t_stacks				*ft_checker_input_handling(char **argv,
							t_stacks *stacks);
char					**ft_initialize_table(char **table);
int						ft_find_newline(char *move, int i);
int						ft_read_and_execute_sequence(int found,
							t_stacks *stacks);
int						ft_find_and_execute_move(char *move, t_stacks *stacks,
							int i, int found);
int						ft_match_input_and_execute_move(char *move,
							char *table_entry, t_stacks *stacks, int i);
